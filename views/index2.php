...
<!--[if gt IE 9]><!--><html class="no-js" lang="en"><!--<![endif]-->
    ...
    <title>Castit</title>
        ...
        <link rel="stylesheet" type="text/css" href="images/slide/css/demo.css" />
        <link rel="stylesheet" type="text/css" href="images/slide/css/style3.css" />
    <script type="text/javascript" src="images/slide/js/modernizr.custom.86080.js"></script>
    </head>
    <body id="page">
        <ul class="cb-slideshow">
            ...
            <li><span>Image 11</span><div></li>
            <li><span>Image 12</span><div></li>
        </ul>
