...
main.controller('RegisterStep6Controller', ['$scope', '$filter', '$http', '$window', '$rootScope', '$routeParams', 'FlashService', function($scope, $filter, $http, $window, $rootScope, $routeParams, FlashService) {
  ...
  document.getElementById("ansigt_text_field").value    = sessionStorage.getItem('ansigt_text_field');
  document.getElementById("profil_text_field").value    = sessionStorage.getItem('profil_text_field');
  document.getElementById("helfigur_text_field").value  = sessionStorage.getItem('helfigur_text_field');
  document.getElementById("ekstra_text_field").value    = sessionStorage.getItem('ekstra_text_field');
  document.getElementById("ekstra1_text_field").value   = sessionStorage.getItem('ekstra1_text_field');
  document.getElementById("ekstra2_text_field").value   = sessionStorage.getItem('ekstra2_text_field');
  
  document.getElementById("hand_text_field").value      = sessionStorage.getItem('hand_text_field');
  document.getElementById("foot_text_field").value      = sessionStorage.getItem('foot_text_field');
  document.getElementById("family_text_field").value    = sessionStorage.getItem('family_text_field');
  document.getElementById("tvilling_text_field").value  = sessionStorage.getItem('tvilling_text_field');
  
  document.getElementById("video1_text_field").value    = sessionStorage.getItem('video1_text_field');
  document.getElementById("video2_text_field").value    = sessionStorage.getItem('video2_text_field');
  document.getElementById("video3_text_field").value    = sessionStorage.getItem('video3_text_field');
  document.getElementById("video4_text_field").value    = sessionStorage.getItem('video4_text_field');
...
main.controller('AngularLoginController', ['$scope', '$filter', '$http', '$window', '$rootScope', 'FlashService', '$cookies', function($scope, $filter, $http, $window, $rootScope, FlashService, $cookies) { 
	...
	$(".login_link").click(function(){
		if($("#login_email").hasClass('ng-valid') && $("#login_email").val()!=""){
			...
			$("input[type=submit].login_button1").trigger("click");
		}
	});
