angular
  ...
  .controller('NavigationController', ['$scope', '$location', '$timeout', function($scope, $location, $timeout) {
    ...
    $scope.menu = [{
      ...
      label: 'Lost Pets Management ',
      iconClasses: 'glyphicon glyphicon-th-list',
      html: '',
	  url: '#/lostpets-management'
    }, {
      label: 'Found Pets Management',
      iconClasses: 'glyphicon glyphicon-th-list',
      html: '',
	  url: '#/foundpets-management'
    }, {
      label: 'Microchip Management',
      iconClasses: 'glyphicon glyphicon-th-list',
      html: '',
	  url: '#/chip-management'
    }, {
      ...
      iconClasses: 'glyphicon glyphicon-th-list',
      html: '',
	  url: '#/breed-management'
    }, {
      label: 'Species Management',
      iconClasses: 'glyphicon glyphicon-th-list',
      html: '',
	  url: '#/species-management'
    }];
