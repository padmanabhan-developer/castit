    ...
    f.extend(MediaElementPlayer.prototype, {
        ...
        buildfullscreen: function(a, c, b, d) {
            if (a.isVideo) {
                ...
                var e = this,
                    g = f('<div class="mejs-button1 mejs-fullscreen-button"><button id="fullscreenbutton" class="fullscreenon" type="button" aria-controls="' + e.id + '" title="' + e.options.fullscreenText + '"></button></div>').appendTo(c);
        ...
        enterFullScreen: function() {
            ...
            if (!(a.media.pluginType !== "native" && (mejs.MediaFeatures.isFirefox || a.options.usePluginFullScreen))) {
				...
				var imgicons = document.getElementById('image_icons');
				var videoicons = document.getElementById('video_icons');
				imgicons.style.display = "none";
				videoicons.style.display = "none";
               ...
               /*if (a.media.pluginType === "native")
				...
				a.container.parent().parent().removeClass("video_call4").addClass("video_call8");
                a.setControlsSize();
                a.isFullScreen = true
            }
        },
            ...
            if (this.media.pluginType !== "native" && mejs.MediaFeatures.isFirefox) this.media.setFullscreen(false);
               ...
               /* this.container.removeClass("mejs-container-fullscreen").width(normalWidth).height(normalHeight);
                ...
                this.layers.children("div").width(normalWidth).height(normalHeight);*/
 				//var imgicons = document.getElementById('image_icons');
				//var videoicons = document.getElementById('video_icons');
				document.getElementById('image_icons').style.display = "block";
				document.getElementById('video_icons').style.display = "block";
				$('#videodiv').removeClass("video_call8").addClass("video_call4");
                this.fullscreenBtn.removeClass("mejs-unfullscreen").addClass("mejs-fullscreen");
				this.container.parent().parent().removeClass("video_call8").addClass("video_call4");
                this.setControlsSize();
