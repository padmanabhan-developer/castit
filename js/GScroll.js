...
height: "280px"
    ...
    Plugin.prototype = {
        ...
        init: function() {
            ...
            .parent().after('<div class="GScroll-barmain"></div>').after('<div class="GScroll-bar"></div>');
        ...
        */
        adjust: function(callback) {
            ...
            self.barHeight = Math.max(100,(self.conHeight - Math.abs(self.conHeight - self.scrollHeight)));
